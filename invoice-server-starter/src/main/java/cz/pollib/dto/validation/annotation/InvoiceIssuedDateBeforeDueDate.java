...
import cz.pollib.dto.validation.validator.InvoiceIssuedDateBeforeDueDateValidator;
 ...
 */
@Constraint(validatedBy = InvoiceIssuedDateBeforeDueDateValidator.class)
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
public @interface InvoiceIssuedDateBeforeDueDate {
